...
public class SpawnManager : MonoBehaviour
{
    ...
    void SpawnCar()
    {
        ...
        foreach (GameObject roadObject in roadObjects)
        {
            ...
            {
                Instantiate(car[0], roadObject.transform.position + new Vector3(Random.Range(10, 13), 0, 0), car[0].transform.rotation);
            }
        ...
        foreach (GameObject roadObject1 in roadObjects1)
        {
            if (MoveScript.gameOver == false)
            {
                Instantiate(car[1], roadObject1.transform.position + new Vector3(Random.Range(10, 13), 0, 0), car[1].transform.rotation);
            }
        ...
        foreach (GameObject roadObject2 in roadObjects2)
        {
            if (MoveScript.gameOver == false)
            {
                Instantiate(car[2], roadObject2.transform.position + new Vector3(Random.Range(-12, -9), 0, 0), car[2].transform.rotation);
            }
        ...
        foreach (GameObject roadObject3 in roadObjects3)
        {
            if (MoveScript.gameOver == false)
            {
                Instantiate(car[3], roadObject3.transform.position + new Vector3(Random.Range(-12, -9), 0, 0), car[3].transform.rotation);
            }
